...
public:
    ...
    virtual QString group() const { return "cumbia-image-widget"; }
...
class QuImageWidgetInterface : public CuCustomWidgetInterface
{
   Q_OBJECT
    Q_INTERFACES(QDesignerCustomWidgetInterface)

  public:
    QuImageWidgetInterface(QObject* parent, CumbiaPool *cumbia_p, const CuControlsFactoryPool &ctrl_factory_p);
    virtual QWidget* createWidget(QWidget* parent);
};

class QuImageScrollAreaInterface : public CuCustomWidgetInterface
{
   Q_OBJECT
    Q_INTERFACES(QDesignerCustomWidgetInterface)

  public:
    QuImageScrollAreaInterface(QObject* parent, CumbiaPool *cumbia_p, const CuControlsFactoryPool &ctrl_factory_p);
    virtual QWidget* createWidget(QWidget* parent);
};
